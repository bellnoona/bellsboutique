...
<!-- <article> -->
<h1>상품정보수정</h1>
<form action="cloUpdatePro.jsp" method="post" enctype="multipart/form-data">
<input type="hidden" name="num" value="<%=num%>">
<table class="table">
<tr><th>비밀번호</th><td><input type="password" name="pass"></td></tr>
<tr><th>상품 이름</th><td><input type="text" name="pname" value="<%=cb.getPname()%>"></td></tr>
<tr><th>상품 가격</th><td><input type="text" name="price" value="<%=cb.getPrice()%>"></td></tr>
<tr><th>제조사</th><td><input type="text" name="factory" value="<%=cb.getFactory()%>"></td></tr>
<tr><th>상품 이미지</th>
 <td><input type="file" name="image" ><%=cb.getImage()%>
      <input type="hidden" name="oldimage" value="<%=cb.getImage()%>"></td></tr>
</table>
<div id="table_search">
