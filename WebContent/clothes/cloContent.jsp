...
cloBean cb = cdao.getBoard(num);
%>

<table class="product">
<tr>
   <td rowspan="6" class="image"><img src="../upload/<%=cb.getImage() %>" width="600" height="600"></td>
   <td colspan="2" class="pname"><%=cb.getPname()%></td>
</tr>
<tr>
    <td class="first">판매가</td>
    <td class="price"><%=cb.getPrice()%>원</td>
</tr>
<tr>
...
<tr>
    ...
    <td class="second"><%=cb.getFactory()%></td>
</tr>
<tr>
...
<input type="button" value="글수정" class="btn1" 
        onclick="location.href='cloUpdateForm.jsp?num=<%=cb.getNum()%>'">
<input type="button" value="글삭제" class="btn1" 
        onclick="location.href='cloDeleteForm.jsp?num=<%=cb.getNum()%>'">	
	<%
	}
}
%>
...
<input type="button" value="리뷰작성" class="btn3" 
              onclick="location.href='../review/fwriteForm.jsp?num=<%=num%>'">
</div>
<div class="clear"></div>
<div id="page_control">
