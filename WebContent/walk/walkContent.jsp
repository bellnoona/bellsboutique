...
<table class="product">
<tr>
   <td rowspan="6" class="image"><img src="../upload/<%=wb.getImage() %>" width="600" height="600"></td>
   <td colspan="2" class="pname"><%=wb.getPname()%></td>
</tr>
<tr>
    <td class="first">판매가</td>
    <td class="price"><%=wb.getPrice()%>원</td>
</tr>
<tr>
...
<tr>
    ...
    <td class="second"><%=wb.getFactory()%></td>
</tr>
<tr>
...
<input type="button" value="글수정" class="btn1" 
        onclick="location.href='walkUpdateForm.jsp?num=<%=wb.getNum()%>'">
<input type="button" value="글삭제" class="btn1" 
        onclick="location.href='walkDeleteForm.jsp?num=<%=wb.getNum()%>'">	
	<%
	}
}
%>
